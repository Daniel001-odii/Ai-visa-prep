    ...
    <div class="min-h-screen  py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-3xl mx-auto text-center mb-12">
        ...
        <p class=" max-w-xl mx-auto">
          Get the most out of your visa application process with our premium features
        </p>
      ...
      <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <UCard class=" overflow-hidden border-blue-500 relative">
          ...
          <div class="absolute top-0 right-0">
            <div class="bg-blue-500 text-xs font-semibold px-3 py-1 text-white rounded-bl-lg">
              RECOMMENDED
            </div>
          </div>
          ...
          <div class="p-6">
            ...
            <div class="mb-6">
              ...
              <div class="text-slate-400 text-sm">
                {{ billing === 'yearly' ? 'That\'s just $7.99/month, billed annually' : '' }}
              </div>
            </div>
            
            <button class="w-full py-2.5 px-4 rounded-lg bg-blue-500 text-white font-medium hover:bg-blue-600 transition-colors">
              Upgrade Now
            </button>
          </div>
          ...
          <div class="border-t border-slate-700 p-6">
            ...
            <ul class="space-y-3">
              <li class="flex items-start">
                <CheckCircle class="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
                <span class="text-sm ">Unlimited AI interview practice sessions</span>
              </li>
              <li class="flex items-start">
                <CheckCircle class="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
                <span class="text-sm ">All difficulty levels (Beginner, Standard, Advanced)</span>
              </li>
              <li class="flex items-start">
                <CheckCircle class="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
                <span class="text-sm ">Personalized feedback and improvement tips</span>
              </li>
              <li class="flex items-start">
                <CheckCircle class="h-5 w-5 text-blue-500 mr-3 flex-shrink-0" />
      ...
      <div class="max-w-3xl mx-auto mt-16">
        <h2 class="text-xl font-semibold mb-6 text-center">Frequently Asked Questions</h2>
        ...
        <div class="space-y-4">
          <div class="bg-slate-800/5 rounded-lg p-4">
            ...
            <div v-if="openFaq === 1" class="mt-2 text-sm ">
              Our premium plan provides unlimited interview practice with AI, personalized feedback, and document review to significantly increase your chances of visa approval. You'll be better prepared for your actual interview and have all your documents in perfect order.
            </div>
          </div>
          ...
          <div class="bg-slate-800/5 rounded-lg p-4">
            ...
            <div v-if="openFaq === 3" class="mt-2 text-sm ">
              Yes, we offer a 7-day money-back guarantee. If you're not satisfied with our premium features, contact our support team within 7 days of your purchase for a full refund.
            </div>
          </div>
        </div>
      </div>
      ...
      <UCard class="max-w-3xl mx-auto mt-16 bg-slate-80/5 rounded-xl">
        <div class="flex items-start">
          ...
          <div>
            <p class=" italic mb-4">
              "The premium plan was a game-changer for my student visa application. The advanced interview practice helped me answer difficult questions confidently, and I got my visa approved on the first try!"
            </p>
